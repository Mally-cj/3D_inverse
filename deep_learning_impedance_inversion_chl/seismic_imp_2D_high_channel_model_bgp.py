...
segy=_read_segy("/home/shendi_gjh_cj/codes/3D_project/data/yyf_smo_train_Volume_PP_IMP.sgy")
...
# impedance_model = np.array(impedance_model).reshape(251,1182,601).transpose(2,1,0)
# impedance_model = np.log(impedance_model)
